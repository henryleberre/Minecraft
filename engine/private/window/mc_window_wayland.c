...
bool mc_window_show   (const mc_window_handle_t windowHandle) { return MC_FAIL_VALUE; }
bool mc_window_hide   (const mc_window_handle_t windowHandle) { return MC_FAIL_VALUE; }
...
bool mc_window_destroy(const mc_window_handle_t windowHandle) { return MC_FAIL_VALUE; }

#endif // MC_DWM_WAYLAND