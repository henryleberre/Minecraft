...
bool mc_window_show   (const mc_window_handle_t pWindowHandle);
bool mc_window_hide   (const mc_window_handle_t pWindowHandle);
bool mc_window_update (const mc_window_handle_t pWindowHandle);
bool mc_window_is_open(const mc_window_handle_t pWindowHandle);
bool mc_window_destroy(const mc_window_handle_t pWindowHandle);
